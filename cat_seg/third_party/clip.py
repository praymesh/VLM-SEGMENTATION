...
_MODELS = {
    "SIGLIP-2": "C:/Users/prana/Downloads/CAT-Seg-main/CAT-Seg-main/SIGLIP2.pt"
}
...
#
    transform = Compose([
        Resize(n_px, interpolation=Image.BICUBIC),  # Resizes the shorter side to n_px (224)
        CenterCrop(n_px),  # Crops the center to n_px x n_px (224x224)
